...
<div>
    <Card>
        ...
        <Card>
            <div style='height: 20px' v-border v-htmlRender v-auto="{value: 'test', bg: 'pink'}"></div>
        </Card>
        <Card>
            <div>{{'fortune' | capitalize}}</div>
            <div>{{'2018-01-01 10:10:25' | formatTime}} <=======================> {{1527782400000 | formatTime('yyyy-MM-dd h:m:s')}}</div>
        </Card> 
    </div>
</template>
